...
xgb_model = pickle.load(open('churn_project/model.pkl', 'rb'))
scaler = pickle.load(open('churn_project/scaler.pkl', 'rb'))
encoder = pickle.load(open('churn_project/encoder.pkl', 'rb'))
